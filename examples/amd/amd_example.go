...
func main() {
	...
	//err = amdInteraction.WaitForBeginProcessing(10 * time.Second)
	//if err != nil {
	...
	//err = amdInteraction.WaitForBargeIn(10 * time.Second)
	//if err != nil {
	...
	//err = amdInteraction.WaitForEndOfSpeech(10 * time.Second)
	//if err != nil {
