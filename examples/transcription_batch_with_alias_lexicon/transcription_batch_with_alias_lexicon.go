...
func main() {
	...
	// Create interaction.
	transcriptionInteraction, err := sessionObject.NewTranscription(language, phrases, grammars,
		audioConsumeSettings, normalizationSettings, vadSettings, recognitionSettings,
