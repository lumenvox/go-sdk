...
func main() {
	...
	normalizationSettings := client.GetNormalizationSettings(false, false, false, false, true, nil)

	// Create interaction.
	transcriptionInteraction, err := sessionObject.NewTranscription(language, nil, nil, audioConsumeSettings, normalizationSettings,
